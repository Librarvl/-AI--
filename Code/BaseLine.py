...
## 5折交叉验证方式
sk = StratifiedKFold(n_splits=5, shuffle=True, random_state=0)              # 分层 5 折交叉验证    抽样后的训练集和验证集的样本分类比例和原有的数据集尽量是一样的
for train_ind, val_ind in sk.split(X_data, Y_data):                         # 保证划分出的 5 个数据集中根据类别所占比例相同
